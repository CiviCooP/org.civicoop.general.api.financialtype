 ...
 * @subpackage API_FinancialType
 *
 * @copyright CiviCRM LLC (c) 2004-2013
 * @version $Id: FinancialType.php 2011-02-16 ErikHommel $
 */

require_once 'CRM/Financial/BAO/FinancialType.php';

/**
 * Add an FinancialType for a contact
 *
 * Allowed @params array keys are:
 *
 * @example FinancialTypeCreate.php Standard Create Example
 *
...
/**
 * Deletes an existing FinancialType
 *
 * @param  array  $params
 *
 * @example FinancialTypeDelete.php Standard Delete Example
 *
...
/**
 * Retrieve one or more financial_types
 *
 * @param  array input parameters
 *
 *
 * @example FinancialTypeGet.php Standard Get Example
 *
